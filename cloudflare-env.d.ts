/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: eb4fa2b28757a681014c65e7a636c5fd)
// Runtime types generated with workerd@1.20251105.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* osm-address-audit */;
		ASSETS: Fetcher;
	}
}
